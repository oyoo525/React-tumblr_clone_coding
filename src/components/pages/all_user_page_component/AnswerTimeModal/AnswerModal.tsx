				...
				<div className="modal_flex">
					<div className="modal_box login_modal_box">
						...
						<div className="modal_content">
							<span className="text_color01">전 세계 화제 인물들이 자신의 Tumblr 질문을 공개해 며칠간 모두의 질문을 받습니다. 궁금한 건 무엇이든. 그러면, 자신의 블로그에서 한 시간 동안 최대한 많은 질문에 실시간 답변합니다. 아 참! 질문은 조금 귀찮아도 영어로 해주세요.<br/><br/>
